...
public class FrmSeeBill extends javax.swing.JFrame {

    private String customerId;
    
    public FrmSeeBill(String cedulaCliente) {
        this.setLocationRelativeTo(null);
        this.customerId = cedulaCliente;
        initComponents();
        loadData();
    }
    ...
    public void loadData(){
        ...
        if (order != null) {
            ...
            String bill = String.format("FACTURA\n-------------------------------------------\n" +
                    ...
                    "-------------------------------------------\n" +
                    "Total: $%.2f",
                    customerName, customerIdCard, customerContactNumber, customerAddress, customerEmail, formattedDate, details.toString(), total);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSeeBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
