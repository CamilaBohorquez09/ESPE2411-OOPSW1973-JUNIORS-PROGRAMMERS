...
public class FrmSaleNote extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (order != null) {
            ...
            new FrmSeeSaleNote(id).setVisible(true);
            dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSaleNote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
