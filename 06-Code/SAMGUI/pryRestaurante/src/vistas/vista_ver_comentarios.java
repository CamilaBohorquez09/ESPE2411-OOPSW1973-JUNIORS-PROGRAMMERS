 ...
 * @author antho
 */
public class vista_ver_comentarios extends javax.swing.JFrame {

    /**
     * Creates new form vista_ver_comentarios
     */
    public vista_ver_comentarios() {
        initComponents();
    ...
    private void cargarDatosMongoDB() {
        ...
        int contador = 1; // Para numerar los comentarios
        ...
        for (Document doc : documents) {
            ...
            if (fechaObj instanceof java.util.Date) {
                ...
                fecha = dateFormat.format((java.util.Date) fechaObj);
            }

            // Formatear los datos como "Comentario n: [comentario] - Fecha: [fecha]"
            comentariosTexto.append("--------- Comentario ")
                            .append(contador)
                            .append("--------- \n")
                            .append(comentario)
                            .append("\nFecha: ")
        ...
        // Cargar los comentarios formateados en el JTextArea
        jTextArea1.setText(comentariosTexto.toString());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vista_ver_comentarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vista_ver_comentarios().setVisible(true);
            }
        });
    }
