 ...
 * @author antho
 */
public class vista_vermenu extends javax.swing.JFrame {

    /**
     * Creates new form vista_vermenu
     */
    public vista_vermenu() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vista_vermenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vista_vermenu().setVisible(true);
            }
        });
    }
