 ...
 * @author antho
 */
public class vista_cambiarpw extends javax.swing.JFrame {

    /**
     * Creates new form vista_cambiarpw
     */
    public vista_cambiarpw() {
        initComponents();
    ...
    private void cargarDatosMongoDB() {
        ...
        if (document != null) {
            ...
            // Cargar la contraseña en el JTextField
    ...
    try {
        ...
        updateQuery.append("password", currentPassword); // Buscar por la contraseña actual

        Document newValues = new Document();
        newValues.append("password", newPassword1); // Nueva contraseña
        ...
        if (modifiedCount > 0) {
            ...
            // Actualizar el JTextField de la contraseña actual
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vista_cambiarpw.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vista_cambiarpw().setVisible(true);
            }
        });
    }
