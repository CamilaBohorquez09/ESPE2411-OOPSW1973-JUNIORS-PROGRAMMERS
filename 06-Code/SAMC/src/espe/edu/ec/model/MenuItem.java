...
public class MenuItem {
    ...
    public MenuItem(int id, String name, String description, float price, int inventory) {
        ...
        menuItems.add(this); // Agregar al listado global
    }

    // Inicializar el menú con elementos predefinidos
    public static void initializeMenu() {
        if (menuItems.isEmpty()) {
            new MenuItem(1, "Guata pequeña", "Plato tradicional de guata", 1.50f, 50);
    ...
    // Obtener un item del menú por su nombre
    ...
    // Reducir el inventario de un item
